class WebDAW {
    constructor() {
        ...
        this.trackConfigs = [
            { name: 'Violino', file: 'audio/Violino.mp3', color: '#ea00ffff' },
            { name: 'Clarinete', file: 'audio/Clarinete.mp3', color: '#fbff00ff' },
            { name: 'Cello', file: 'audio/Cello.mp3', color: '#09ff00ff' },
